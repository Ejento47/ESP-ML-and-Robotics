...
from pathplanning_V4 import  ParkPathPlanning, interpolate_b_spline_path, interpolate_path
...
if __name__ == '__main__':
    ...
    while len(path) > 0: #while path is not empty
        ...
        my_car.sensor_update(my_car.x, my_car.y, path_planner.a_star.obstacle_map, empty_spaces, 20) #constantly update the sensor
